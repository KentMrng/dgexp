...
class DGParser(object):
    ...
    def add(self, v1, v2):
        return self._connect_plus_minus_average(Operation.plus, v1, v2)

    def subtract(self, v1, v2):
        return self._connect_plus_minus_average(Operation.minus, v1, v2)
    ...
    def multiply(self, v1, v2):
        return self._connect_multiply_divide(Operation.multiply, v1, v2)

    def divide(self, v1, v2):
        return self._connect_multiply_divide(Operation.divide, v1, v2)

    def pow(self, v1, v2):
        return self._connect_multiply_divide(Operation.pow, v1, v2)

    def exp(self, v):
        return self._connect_multiply_divide(Operation.pow, math.e, v)

    def sqrt(self, v):
        return self._connect_multiply_divide(Operation.pow, v, 0.5)
